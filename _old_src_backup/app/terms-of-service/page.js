            ...
            <main className="container mx-auto px-4 sm:px-6 -mt-10 md:-mt-16 relative z-20 pb-20 max-w-4xl">
                <div className={`rounded-[2.5rem] p-8 md:p-12 lg:p-16 shadow-[0_40px_100px_rgba(43,58,160,0.1)] border ${isDark ? 'bg-[#111B3A] border-[#1A264A]' : 'bg-white border-slate-200'}`}>
                    ...
                    <div className={`prose max-w-none ${isDark ? 'prose-invert prose-p:text-slate-300 prose-headings:text-white prose-a:text-[#FFB31A]' : 'prose-p:text-slate-600 prose-headings:text-[#2B3AA0] prose-a:text-[#2B3AA0]'}`}>
                        ...
                        <h3 className="text-2xl font-black uppercase tracking-tight mt-10 mb-4">Limitation on Liability</h3>
                        <p>
                        ...
                        <h3 className="text-2xl font-black uppercase tracking-tight mt-10 mb-4">Term and Termination</h3>
                        <p>
                        ...
                        <h3 className="text-2xl font-black uppercase tracking-tight mt-10 mb-4">Copyright Policy</h3>
                        <p>
                        ...
                        <h3 className="text-2xl font-black uppercase tracking-tight mt-10 mb-4">General</h3>
                        <p>
                        ...
                        <h3 className="text-2xl font-black uppercase tracking-tight mt-10 mb-4">Dispute Resolution</h3>
                        <p>Please read this Arbitration Agreement carefully. It is part of your contract with Company and affects your rights. It contains procedures for MANDATORY BINDING ARBITRATION AND A CLASS ACTION WAIVER.</p>
                        ...
                        <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief. A Notice to the Company should be sent to: SNN Raj Serenity, Begur Koppa Road, Bangalore -560068, India. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally. If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding. The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
                        ...
                        <h3 className="text-2xl font-black uppercase tracking-tight mt-10 mb-4">Electronic Communications</h3>
                        <p>
                            The communications between you and Company use electronic means, whether you use the Site or send us emails, or whether Company posts notices on the Site or communicates with you via email. For contractual purposes, you (a) consent to receive communications from Company in an electronic form; and (b) agree that all terms and conditions, agreements, notices, disclosures, and other communications that Company provides to you electronically satisfy any legal obligation that such communications would satisfy if it were be in a hard copy writing.
                        </p>

                        <h3 className="text-2xl font-black uppercase tracking-tight mt-10 mb-4">Entire Terms</h3>
                        <p>
                        ...
                        <h3 className="text-2xl font-black uppercase tracking-tight mt-10 mb-4 text-[#FFB31A]">Refund and Cancellation Policy</h3>
                        <p className="font-bold">
                            No refunds can be claimed for unattended classes.
                        </p>

                        <h3 className="text-2xl font-black uppercase tracking-tight mt-10 mb-4">Governing Law</h3>
                        <p>
                            The laws of the India, shall govern these Terms of Use, regardless of Your location. You hereby expressly consent to exclusive jurisdiction of Bangalore courts for all matters or disputes arising out of or relating to these Terms of Use or your access or use of the Website.
                        </p>

                        <h3 className="text-2xl font-black uppercase tracking-tight mt-10 mb-4">Copyright/Trademark Information</h3>
                        <p>
