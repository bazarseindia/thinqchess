...
// Advanced real-world gallery data mixed with Instagram style metrics
// Mix of Event photos, Tournament highlights, and Academy kids
const galleryData = [
...
const categories = ['All', 'Tournaments', 'Events', 'Training', 'Graduation', 'Awards'];
...
export default function GalleryPage() {
  ...
  useEffect(() => {
    if (activeCategory === 'All') {
      ...
      setItems(galleryData.filter(item => item.category === activeCategory));
    }
  }, [activeCategory]);
