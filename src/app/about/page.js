        ...
        <main className={`min-h-screen ${isDark ? 'bg-[#0A1128]' : 'bg-white'}`}>
            ...
            <section className="relative min-h-[80vh] md:min-h-[90vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0">
                    <img loading="lazy" src="/assets/For website/Academy photo.jpeg"
                        ...
                        >
                            <div className="relative">
                                <div className="rounded-2xl overflow-hidden shadow-2xl">
                                    <img loading="lazy" src="/assets/For website/Chess Board vision.jpeg"
                        ...
                        <div className="lg:col-span-6 order-2 lg:order-1 relative">
                            ...
                            >
                                <div className="rounded-2xl overflow-hidden border-4 border-white/10">
                                    <img loading="lazy" src="/assets/For website/IMG_8974.JPG" className="w-full shadow-2xl" alt="Our Vision" />
                                </div>
                ...
                <div className="container mx-auto px-4 sm:px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                        ...
                        >
                            <div className="relative">
                                <div className="rounded-2xl overflow-hidden shadow-2xl">
                                    <img loading="lazy" src="/assets/For website/Thinq Chess Tournament.jpeg"
