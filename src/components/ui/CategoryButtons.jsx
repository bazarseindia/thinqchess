    ...
    const categories = [
        {
            ...
            num: "01",
            icon: Sparkles,
            img: media.img_btn_play_fun || "/assets/home/Course completion photo 1.jpeg",
            href: "/registration"
        },
        {
            title: "Intermediate",
            ...
            num: "02",
            icon: Target,
            img: media.img_btn_tournaments || "/assets/home/Internal Tournament.jpeg",
            href: "/registration"
        },
        {
            title: "Advanced",
            ...
            num: "03",
            icon: Trophy,
            img: media.img_btn_trainer || "/assets/home/Academy photo.jpeg",
            imgClass: "object-top",
            href: "/registration"
        },
        {
            ...
            num: "04",
            icon: Crown,
            img: media.img_btn_elite || "/assets/home/Practice time.jpeg",
            href: "/registration"
        }
    ];
                                ...
                                <Link href={cat.href} className="flex-1 w-full relative">
                                    <div className={`p-1.5 rounded-[2.5rem] border shadow-2xl transition-all duration-500 overflow-hidden flex flex-col h-full bg-white group-hover:-translate-y-2 ${isDark ? 'border-[#111B3A] shadow-black/40' : 'border-slate-200 shadow-[#2B3AA0]/5 hover:border-[#FFB31A]/40'}`}>
                                        ...
                                        <div className="w-full h-48 sm:h-56 lg:h-48 rounded-[2rem] overflow-hidden relative">
                                            <img loading="lazy" src={cat.img} className={`w-full h-full object-cover transition-transform duration-[1.5s] ease-out group-hover:scale-110 ${cat.imgClass || 'object-center'}`} alt={cat.title} />
